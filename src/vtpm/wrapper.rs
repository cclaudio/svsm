...
use crate::mm::alloc::{layout_from_size, mem_allocate, mem_deallocate, layout_from_ptr, mem_reallocate};
use crate::sev::msr_protocol::request_termination_msr;

use core::alloc::Layout;
use core::ffi::{c_ulong, c_void, c_char, c_int};
use core::ptr;
...
pub extern "C" fn realloc(p: *mut c_void, size: c_ulong) -> *mut c_void {
    ...
    let layout: Layout = layout_from_ptr(ptr);

    mem_reallocate(ptr, layout, new_size) as *mut c_void
}
